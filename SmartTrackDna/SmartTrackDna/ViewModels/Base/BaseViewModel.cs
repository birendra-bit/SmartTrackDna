...
namespace SmartTrackDna.ViewModels.Base
{
    public abstract class BaseViewModel : ExtendedBindableObject
    {
        ...
        {
            if (DisplayAlertEvent != null)
                DisplayAlertEvent?.Invoke(Resources.DialogTitleError, message, Resources.DialogLabelOk);
        }

        public void DisplaySuccessAlert(string message)
        {
            if (DisplayAlertEvent != null)
                DisplayAlertEvent?.Invoke(Resources.DialogTitleSuccess, message, Resources.DialogLabelOk);
        }
